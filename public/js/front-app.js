...
newGamebuttons.forEach(function (item) {
  return item.addEventListener('click', restart);
});
...
socket.on('user times', function (times) {
  printTimeOnDesktop();
});

socket.on('display error', function () {
...
//# sourceMappingURL=front-app.js.map